...
The following scripts are avaialbe from demosmbc(https://github.com/jbnetapp/demosmbc) to automatically build you SMBC configuration between cluster1 and cluster2:
